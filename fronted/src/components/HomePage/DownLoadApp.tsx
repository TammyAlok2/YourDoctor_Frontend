...
export default function DownloadApp() {
  ...
  return (
    <div className="flex items-center h-[5rem] relative right-0">
      <div className="absolute right-4 top-3 flex items-center">
      <h1 className="border-[0.1rem] border-black rounded-md px-2 py-1 border-r-transparent mr-[-0.1rem] relative hover:bg-teal-100 cursor-pointer" data-aos='fade-out' onClick={handleOpenDownloadSelect}>Download App</h1>
      {openSelect && <ul>
        <li className="border-[0.1rem] border-black rounded-md px-2 py-1 border-r-transparent -mr-1 relative hover:bg-teal-100 cursor-pointer" data-aos='fade-bottom'>Patient App</li>
        <li className="border-[0.1rem] border-black rounded-md px-2 py-1 border-r-transparent -mr-1 relative hover:bg-teal-100 cursor-pointer" data-aos='fade-top'>Doctor App</li>
      </ul>}
      <div className="relative w-[3rem] h-[5rem] bg-gray-300 rounded-lg border-[0.1rem] border-black flex items-center justify-center cursor-pointer" onClick={handleOpenDownloadSelect}>
        {/* Mobile Outer Layer */}
        <div className="absolute w-[90%] h-[85%] bg-white border-[0.1rem] overflow-hidden border-black rounded-md flex flex-col items-center justify-center">
          ...
          <div className="overflow-hidden relative w-full h-full">
            ...
            >
              {/* "Hi" text */}
              <span className="text-2xl font-bold text-red-600" data-aos='fade-up'><Image width={150} height={150} src={"/YOURLab_Logo.png"} alt="map-gif"/></span>
            </div>
          </div>
        </div>
