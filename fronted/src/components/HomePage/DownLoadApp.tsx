...
export default function DownloadApp() {
  ...
  return (
    <div className="flex items-center h-[5rem] relative right-0">
      ...
      <div className="relative w-[3rem] h-[5rem] rounded-lg border-[0.1rem] border-black flex items-center justify-center cursor-pointer" onClick={handleOpenDownloadSelect}>
        {/* Mobile Outer Layer */}
