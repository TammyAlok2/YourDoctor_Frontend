...
const AppointmentProcess = () => {
    return (
        <div className="bg-[rgb(252_251_253)] py-16 relative">
            <Image className="absolute bottom-0 left-0" width='300' height='300' src='/appointprocessimg1.png' alt='background-image' />
            <Image className="absolute top-0 right-0" width='300' height='300' src='/appointprocessimg2.png' alt='background-image' />
            <div className="text-center mb-12">
                <p className="text-teal-400 uppercase tracking-widest font-bold mb-2">Process</p>
                <h2 className="text-4xl font-bold text-[#00224f]">Appointment Process</h2>
            </div>

            <div className="flex justify-center space-x-8">
                {/* Step 1 */}
                <div className="bg-white p-8 rounded-lg shadow-md max-w-[18.5vw] relative hover-animation1">
                    <div className="flex justify-center items-center bg-teal-500 rounded-full w-10 h-10 mb-4 text-white font-bold text-md absolute left-[6.5rem] shadow-lg z-10">01</div>
                    <Image className="relative mb-6" width='100' height='100' src='/appointprocessimg3.png' alt='background-image' />
                    <h3 className="text-xl font-semibold mb-4">Search for the Providers</h3>
                ...
                {/* Step 2 */}
                <div className="bg-white p-8 rounded-lg shadow-md max-w-[18.5vw] relative hover-animation1">
                    <div className="flex justify-center items-center bg-teal-500 rounded-full w-12 h-12 mb-4 text-white font-bold text-md absolute left-[6.5rem] shadow-lg z-10">02</div>
                    <Image className="relative mb-6" width='100' height='100' src='/appointprocessimg4.png' alt='background-image' />
                    <h3 className="text-xl font-semibold mb-4">Schedule for an Appointment</h3>
                    <p className="text-gray-500">
                ...
                {/* Step 3 */}
                <div className="bg-white p-8 rounded-lg shadow-md max-w-[18.5vw] relative hover-animation1">
                    <div className="flex justify-center items-center bg-teal-500 rounded-full w-12 h-12 mb-4 text-white font-bold text-md absolute left-[6.5rem] shadow-lg z-10">03</div>
