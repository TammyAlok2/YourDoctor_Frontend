...
const AppointmentProcess = () => {
  ...
  <div className="flex flex-col lg:flex-row justify-center items-center space-y-8 lg:space-y-0 lg:space-x-8">
    ...
    <div className="bg-white p-6 md:p-8 rounded-lg shadow-md max-w-[90%] sm:max-w-[80%] md:max-w-[50%] lg:max-w-[18.5vw] relative hover-animation1">
      <div className="flex justify-center items-center bg-teal-500 rounded-full w-10 h-10 mb-4 text-white font-bold text-md absolute left-1/2 transform -translate-x-1/2 lg:left-[6.5rem] shadow-lg z-10">01</div>
    ...
    {/* Step 2 */}
    <div className="bg-white p-6 md:p-8 rounded-lg shadow-md max-w-[90%] sm:max-w-[80%] md:max-w-[50%] lg:max-w-[18.5vw] relative hover-animation1">
      <div className="flex justify-center items-center bg-teal-500 rounded-full w-12 h-12 mb-4 text-white font-bold text-md absolute left-1/2 transform -translate-x-1/2 lg:left-[6.5rem] shadow-lg z-10">02</div>
    ...
    {/* Step 3 */}
    <div className="bg-white p-6 md:p-8 rounded-lg shadow-md max-w-[90%] sm:max-w-[80%] md:max-w-[50%] lg:max-w-[18.5vw] relative hover-animation1">
      <div className="flex justify-center items-center bg-teal-500 rounded-full w-12 h-12 mb-4 text-white font-bold text-md absolute left-1/2 transform -translate-x-1/2 lg:left-[6.5rem] shadow-lg z-10">03</div>
