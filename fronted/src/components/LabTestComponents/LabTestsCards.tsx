  ...
  return (
    <>
      {labCardData?.map((data, index) => (
        <div className="flex flex-col bg-white border rounded-lg shadow-md w-[27rem]" key={index}>
        ...
        <div className="p-4 flex gap-3">
          ...
          <div className="w-[16rem]">
            <div className="text-center mb-4 space-y-2">
              <p className="text-[0.8rem] flex text-left "><FaAward className="text-[rgb(255_135_0_/_87%)] rounded-sm bg-[rgba(255,179,93,0.16)] p-1 [filter:drop-shadow(.1rem_.2rem_.1rem_gray)] text-[1.5rem] mr-1" /> {data.achieve}</p>
              <p className="text-[0.8rem] flex items-center"><Image src={"https://tse2.mm.bing.net/th?id=OIP.fLWpg4oYllvUxXniLMvNsQHaHa&pid=Api&P=0&h=220"} alt="time icon" width={21} height={21} className='mr-1' /> Timing: {data.time}</p>
          ...
          <div className="ml-auto flex flex-col items-end">
            <div className="flex justify-center mb-2">
              <div className="w-24 h-24 bg-gray-200 flex items-center justify-center rounded-2xl overflow-hidden border-[#0A8E8A] border-[0.1rem]">
                <Image
                  src={"https://bookmerilab.com/offers/images/thyrocare-logo.png"} // You can replace this with the actual image
                  alt="Lab Logo"
                  width={100}
                  height={100}
            ...
            <div className="flex justify-center mt-4">
              <button className="bg-teal-600 text-white py-2 px-6 rounded-full text-sm">
                Select Lab
              </button>
            </div>
          </div>
